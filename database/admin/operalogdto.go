...
type ListOperaLogReq struct {
	...
	Id                int64     `json:"id" form:"id" search:"type:exact;column:id;table:admin_opera_log"`
...
type OperaLogOrder struct {
	IdOrder            int64     `json:"id" form:"id" search:"type:order;column:id;table:admin_opera_log"`
