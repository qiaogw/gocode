// package model 自动生成模板Config(系统配置)
package admin
...
func NewConfigModel(conn sqlx.SqlConn, c cache.CacheConf, gormX *gorm.DB) ConfigModel {
	return &customConfigModel{
		defaultConfigModel: newConfigModel(conn, c, gormX),
	}
}
